...
CREATE UNIQUE INDEX "oauth_client_resource_pair_unique" ON "oauth_client_resource" USING btree ("client_id","resource_id");--> statement-breakpoint
...
CREATE INDEX "oauth_refresh_token_code_idx" ON "oauth_refresh_token" USING btree ("authorization_code_id");